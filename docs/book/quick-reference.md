...
| 文档 | 用途 | 何时查阅 |
|------|------|---------|
| [glossary.md](./glossary.md) | **术语表** | 每次编写前必看，确保术语一致 |
| [writing-plan-v2.md](./writing-plan-v2.md) | 写作计划详情 | 编写具体章节时 |
| [writing-plan-comparison.md](./writing-plan-comparison.md) | 章节结构说明 | 了解整体结构时 |
